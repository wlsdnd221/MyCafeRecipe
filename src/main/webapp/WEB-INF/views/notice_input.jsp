...
<div class="w3-card-4" style="width: 70%; margin-left: auto; margin-right: auto">
  ...
  <form class="w3-container" action="notice_enroll" method="post" enctype="multipart/form-data">
    <p>      
    ...
    <p>      
	    <label class="w3-text-brown" style="float: left"><b>이미지 첨부</b></label>&emsp;
	    <button type="button" id="btn_submit" onclick="javascript:fn_submit()">선택파일 업로드</button>
	    <input id="picture" class="w3-input w3-border w3-sand" name="picture" type="file">
	</p>
	<p>      
