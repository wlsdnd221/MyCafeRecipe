	...
	<td>
		<div class="w3-container">
		  <div class="w3-card-4">
		    ...
		    <div class="w3-container">		    
		      <form id="form" class="w3-container" action="cafe_menu_enroll" method="post" enctype="multipart/form-data">
					...
					<td>
						<p style="width: 80%">
						  ...
						  <select class="w3-select w3-border w3-sand" id="cafe" name="cafe">
						    ...
						    <option value="starbucks" class="w3-text-brown">스타벅스</option>
						    <option value="hollys" class="w3-text-brown">할리스</option>
						    <option value="ediya" class="w3-text-brown">이디야</option>
						  </select>
						</p>
					</td>
					<td>
				...
				<tr>
					<td colspan="2">
						<p p style="width: 90%">  
						  ...
						  <input type="file" class="w3-input w3-border w3-sand" id="picture" onchange="readURL(this);" name="picture">
						</p>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<p p style="width: 90%">      
						  ...
						  <input class="w3-input w3-border w3-sand" id="product" name="product" type="text">
						</p>
						<p p style="width: 90%">      
						  <label class="w3-text-brown"><b>설명</b></label>
						  <textarea class="w3-input w3-border w3-sand" name="explain" rows="5" cols="10"></textarea>
						</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<p style="width: 80%">      
					      ...
					      <input class="w3-input w3-border w3-sand" id="calorie" name="calorie" type="text" value="0">
					    </p>					 
					    <p style="width: 80%">      
					      <label class="w3-text-brown"><b>포화지방(g)</b></label>
					      <input class="w3-input w3-border w3-sand" id="saturated_fat" name="saturated_fat" type="text" value="0">
					    </p>
					    <p style="width: 80%">      
					      <label class="w3-text-brown"><b>단백질(g)</b></label>
					      <input class="w3-input w3-border w3-sand" id="protein" name="protein" type="text" value="0">
					    </p>					    
					</td>
					<td>
						<p style="width: 80%">      
					      <label class="w3-text-brown"><b>나트륨(mg)</b></label>
					      <input class="w3-input w3-border w3-sand" id="natrium" name="natrium" type="text" value="0">
					    </p>					
					    <p style="width: 80%">      
					      <label class="w3-text-brown"><b>당류(g)</b></label>
					      <input class="w3-input w3-border w3-sand" id="sugar" name="sugar" type="text" value="0">
					    </p>					    
					    <p style="width: 80%">      
					      <label class="w3-text-brown"><b>카페인(mg)</b></label>
					      <input class="w3-input w3-border w3-sand" id="caffeine" name="caffeine" type="text" value="0">
					    </p>					    
					</td>
				</tr>
				</table>
